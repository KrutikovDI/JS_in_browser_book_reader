...
fontSizes.addEventListener("click", (e) => {
  ...
  console.log(bookContent.getAttribute("class"));
...
colorText.addEventListener("click", (e) => {
  ...
  if (e.target.tagName != "SPAN") {
    ...
    deleteClass(bookContent, "book_color-black", "book_color-gray", "book_color-whitesmoke");
...
colorbg.addEventListener("click", (e) => {
  ...
  if (e.target.tagName != "SPAN") {
    ...
    e.target.classList.add("color_active");
    deleteClass(bookContent, "bg_color_black", "bg_color_gray", "bg_color_white");
